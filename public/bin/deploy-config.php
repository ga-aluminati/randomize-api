 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'iRealizeThisIsInAPublicRepo,FixMeLater');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/ga-aluminati/randomize-api.git');
 ...
 */
define('TARGET_DIR', '/home/httpd/api.randomize.co/');
